        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
              <?php 
                $sql = "SELECT COUNT(id) as hitung FROM buku";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
              <?php 
                $sql = "SELECT COUNT(id) as hitung FROM kategori";
                $result = queryFetch($sql);
                ?>
                <h3><?=$result['hitung']?></h3>
                <p>Kategori</p>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <?php 
                $sql = "SELECT COUNT(id) as hitung FROM pinjam_buku";
                $result = queryFetch($sql);
                ?>
                <h3><?=$result['hitung']?></h3>
                <p>Peminjaman Buku</p>
              ...
              <a href="pinjam_buku.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
